    ...
    set_lap(){
        xrandr --output $monitor_P --primary --mode 1366x768 --pos 0x0 --rotate normal --output $monitor_S --off --output HDMI-1 --off --output DP-1 --off
    }


    #hp homelaptop + Monitor
    set_multmon(){
        xrandr --output $monitor_P --primary --mode 1366x768 --pos 277x1080 --rotate normal --output $monitor_S --mode 1920x1080 --pos 0x0 --rotate normal --output HDMI-1 --off --output DP-1 --off
    }
